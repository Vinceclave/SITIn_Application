...
// Handle new announcement posting
if (isset($_POST['add_announcement']) && !empty($_POST['message'])) {
    $message = $_POST['message'];
    $admin_name = $user['username']; // Store the admin's name

    // Insert announcement into the database
    $insertQuery = "INSERT INTO announcements (admin_name, message) VALUES (?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        $error_message = "An error occurred while posting the announcement.";
    }
}
?>
